...
client_email_list = views.ClientEmailViewSet.as_view({'get':'list'},lookup_field='pk')
client_phone_list = views.ClientPhoneViewSet.as_view({'get':'list'},lookup_field='pk')
client_address_list = views.ClientAddressViewSet.as_view({'get':'list'},lookup_field='pk')
client_birthdate = views.ClientBirthDateViewSet.as_view({'get':'list'},lookup_field='pk')
